# Deploy the wp-offline-builder skill to the user-level Claude skills directory,
...
$src  = "D:\1Agent1\wp-offline-builder"
$dest = Join-Path $env:USERPROFILE ".claude\skills\wp-offline-builder"
...
Write-Output "Deployed wp-offline-builder skill to: $dest"
