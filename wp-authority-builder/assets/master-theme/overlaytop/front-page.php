 ...
 * each section carries a variant class (overlaytop_variant()) that CSS
 * rearranges, and the palette/fonts/radius come from tokens.css. Markup is
 * intentionally consistent so all variants share one template.
 *
 * @package Overlaytop
 */
